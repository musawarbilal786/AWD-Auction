...
export default function AddTransporterPage() {
  ...
  const handleSubmit = async () => {
    try {
      ...
      // Make the API call
      await axios.post(
        `${apiUrl}/transportation/api/v1/transporter/`,
        apiData,
        {
          headers: {
            ...headers,
      ...
      showSuccessToast(COMMON_SUCCESS_MESSAGES.CREATED, "Transporter");
      router.push('/transportation/transporters');
    } catch (error: any) {
      showErrorToast(error, "Transporter creation");
    } finally {
      setLoading(false);
    }
  };
      ...
      <div className="bg-white rounded-xl shadow-md p-6">
        <div className="flex justify-end items-center mb-6">
          <div className="flex gap-2">
            <button className="bg-sky-600 text-white px-4 py-2 rounded-md" type="button" disabled={loading}>Create Password</button>
            <Button 
              type="primary" 
